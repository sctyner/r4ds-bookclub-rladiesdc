...
3.  What’s the difference between `read_csv()` and `read_csv2()`?

4.  Generate the correct format string to parse each of the following
    dates and times:
...
2.  We know that some days of the year are “special”, and fewer people
...
3.  What happened on June 13, 2013? Display the spatial pattern of
...
4.  What does `anti_join(flights, airports, by = c("dest" = "faa"))`
    tell you? What does
